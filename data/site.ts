...
export const site = {
  ...
  about:
    "Я художник по гриму и стилист по прическам. Работаю в этом направлении более 20 лет. Работала в кино, на съёмках рекламных роликов, в телепередачах, музыкальных клипах и фотосессиях.",
  // Open Graph / SEO
